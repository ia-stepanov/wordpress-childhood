<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode( '[contact-form-7 id="199" title="Форма вопросов"]' ); ?>
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('social_instagram', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="<?php the_field('social_facebook', 2); ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="<?php the_field('social_youtube', 2); ?>" class="footer__social-item" target="_blank">
