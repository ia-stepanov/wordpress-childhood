                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode( '[contact-form-7 id="198" title="Форма отзывов"]' ); ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
                                    ...
                                    <?php
                                        ...
                                        foreach( $my_posts as $post ){
                                            ...
                                            <li class="glide__slide">
                                                <div class="feedslider__title"><?php the_field('client_title'); ?></div>
                                                <div class="feedslider__text"><?php the_field('client_text'); ?></div>
                                            </li>
